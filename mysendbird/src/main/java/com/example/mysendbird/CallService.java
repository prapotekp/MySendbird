...
import com.example.mysendbird.utils.ToastUtils;
...
public class CallService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        Log.i("[Module]", "[CallService] onBind()");
        return mBinder;
    }
    ...
    public void onCreate() {
        super.onCreate();
        Log.i("[Module]", "[CallService] onCreate()");
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.i("[Module]", "[CallService] onDestroy()");
    }

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.i("[Module]", "[CallService] onStartCommand()");
    ...
    public void onTaskRemoved(Intent rootIntent) {
        ...
        Log.i("[Module]", "[CallService] onTaskRemoved()");
    ...
    public static void dial(Context context, String doDialWithCalleeId, boolean isVideoCall) {
        if (SendBirdCall.getOngoingCallCount() > 0) {
            ...
            Log.i("[Module]", "[CallService] dial() => SendBirdCall.getOngoingCallCount(): " + SendBirdCall.getOngoingCallCount());
            return;
        }

        Log.i("[Module]", "[CallService] dial()");
    ...
    public static void onRinging(Context context, @NonNull DirectCall call) {
        Log.i("[Module]", "[CallService] onRinging()");
    ...
    private static void startService(Context context, ServiceData serviceData) {
        Log.i("[Module]", "[CallService] startService()");
    ...
    public static void stopService(Context context) {
        Log.i("[Module]", "[CallService] stopService()");
    ...
    public void updateNotification(@NonNull ServiceData serviceData) {
        Log.i("[Module]", "[CallService] updateNotification(isHeadsUpNotification: " + serviceData.isHeadsUpNotification + ", remoteNicknameOrUserId: " + serviceData.remoteNicknameOrUserId
